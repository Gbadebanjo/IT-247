    ...
    <>
      <Container>
        <Description>
          ...
          magnam reprehenderit perferendis esse, placeat tempore rerum officiis
          id voluptatum magni perspiciatis, aliquam nostrum voluptatibus
          explicabo facilis recusandae, eum voluptates itaque?
        </Description>
        <MenuItems>
      ...
      <CopyRight>&copy; 2023 IT 24/7 - All Rights Reserved.</CopyRight>
    </>
  );
};
